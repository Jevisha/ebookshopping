...
namespace ebookshopping.Models
{
    public class usersaccountsController : Controller
    {
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=LAPTOP-NDAHA8SK\\SQLEXPRESS;Initial Catalog=ebookshopping;Integrated Security=True;Connect Timeout=30");
            string sql;
